...
sub new {
    bless( {
        ...
        'MODPERL_AP_LIBS' => '',
        'MODPERL_AR' => 'ar',
        'MODPERL_ARCHLIBEXP' => '/opt/lampp/lib/perl5/5.10.1/i686-linux',
        'MODPERL_CC' => 'gcc',
        'MODPERL_CCCDLFLAGS' => '-fPIC',
        'MODPERL_CCOPTS' => ' -fno-strict-aliasing -pipe -I/usr/local/include -I/opt/lampp/lib/perl5/5.10.1/i686-linux/CORE -DMOD_PERL -DMP_COMPAT_1X -DLINUX=2 -D_REENTRANT -D_GNU_SOURCE -D_LARGEFILE64_SOURCE',
        'MODPERL_CP' => 'cp',
        ...
        'MODPERL_INC' => '-I/home/lampp/modperl/mod_perl-2.0.4/src/modules/perl -I/home/lampp/modperl/mod_perl-2.0.4/xs -I/opt/lampp/include -I/opt/lampp/include -I/opt/lampp/include -I/opt/lampp/include',
        'MODPERL_LD' => 'gcc',
        'MODPERL_LDDLFLAGS' => '-shared -O2 -L/usr/local/lib',
        'MODPERL_LDOPTS' => '-Wl,-E  -L/usr/local/lib  -L/opt/lampp/lib/perl5/5.10.1/i686-linux/CORE -lperl -lnsl -ldl -lm -lcrypt -lutil -lc',
        'MODPERL_LIB' => 'mod_perl.so',
        'MODPERL_LIBNAME' => 'mod_perl',
        'MODPERL_LIBPERL' => '/opt/lampp/lib/perl5/5.10.1/i686-linux/CORE/libperl.a',
        ...
        'MODPERL_PRIVLIBEXP' => '/opt/lampp/lib/perl5/5.10.1',
        'MODPERL_RANLIB' => ':',
        'MODPERL_RM' => 'rm',
        'MODPERL_RM_F' => 'rm -f',
        'MODPERL_TEST_F' => 'test -f',
        'MODPERL_XSUBPP' => '$(MODPERL_PERLPATH) $(MODPERL_PRIVLIBEXP)/ExtUtils/xsubpp -typemap $(MODPERL_PRIVLIBEXP)/ExtUtils/typemap -typemap /home/lampp/modperl/mod_perl-2.0.4/lib/typemap',
        'MP_APR_LIB' => 'aprext',
        'MP_AP_PREFIX' => '/opt/lampp',
        'MP_COMPAT_1X' => 1,
        'MP_GENERATE_XS' => 1,
        'MP_LIBNAME' => 'mod_perl',
        'MP_USE_DSO' => 1,
        ...
        'apr_includedir' => '/opt/lampp/include',
        'apu_config_path' => '/opt/lampp/bin/apu-1-config',
        'cwd' => '/home/lampp/modperl/mod_perl-2.0.4',
        'dir' => '/opt/lampp',
